...
public class MessagePoolTests
{
    ...
    public void PooledMessage_Reuse_MultipleSizes()
    {
        ...
        using (var msg1 = pool.Rent(data1024.AsSpan()))
        {
            if (msg1._isFromPool)
            {
                msg1.ActualDataSize.Should().Be(1024);
            }
        }
        Thread.Sleep(50);
        ...
        using (var msg3 = pool.Rent(data512.AsSpan()))
        {
            if (msg3._isFromPool)
            {
                msg3.ActualDataSize.Should().Be(512);
            }
        }
        Thread.Sleep(50);
        ...
        using (var msg4 = pool.Rent(data128.AsSpan()))
        {
            if (msg4._isFromPool)
            {
                msg4.ActualDataSize.Should().Be(128);
            }
        }
        Thread.Sleep(50);
    ...
    public void SetActualDataSize_ValidSize_Works()
    {
        ...
        if (msg._isFromPool)
        {
            ...
            // Assert
            msg.ActualDataSize.Should().Be(512);
    ...
    public void CopyFromNative_SetsActualDataSize()
    {
        ...
        if (msg._isFromPool && msg._poolDataPtr != nint.Zero)
        {
            ...
            // Assert
            msg.ActualDataSize.Should().Be(256, "CopyFromNative should set actual data size");
